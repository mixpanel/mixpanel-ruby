...
to provide useful features in common situations. One in particular is MetaEvents,
at [https://github.com/swiftype/meta_events], which provides support for client-side tracking
in Rails applications, super-properties-like persistent properties, and a documentation
language for your events.
